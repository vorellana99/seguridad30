...
export class PerfilService {
    ...
    add(perfil:Perfil): Observable<Perfil>{ // Observable<Perfil> es el tipo de lo que devuelve a travez de la API. que puede ser TRUE o FALSE, o un model en JSON
    ...
    update(perfil:Perfil):Observable<Perfil>{ // Observable<Perfil> es el tipo de lo que devuelve a travez de la API. que puede ser TRUE o FALSE, o un model en JSON
