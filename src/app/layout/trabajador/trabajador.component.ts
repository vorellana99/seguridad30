...
export class TrabajadorComponent implements OnInit {
  ...
  constructor(private service: TrabajadorService, private usuarioService: UsuarioService,
  ...
  confirmAdd(item: Trabajador) {
    this.confirmationService.confirm({
        ...
        rejectLabel: 'No',
        accept: () => {
          const usuario: Usuario = { userName: item.codigo, codigo: item.codigo, password: 'asdfWER74!' };
